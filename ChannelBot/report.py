...
async def _manage(_, msg):
    ...
    how += '2) Visit @The_Panda_Official and define your problem **completely**, i.e, what you expected and what happened instead.'
    how += "If you don't get a reply Right away, wait"
    await msg.reply(
        how,
